...
describe("calculateRanking", () => {
  it("score降順、totalRebuyCount昇順で順位を付ける", () => {
    const result = calculateRanking([
      { groupPlayerId: "c", score: 10_000, totalRebuyCount: 2 },
      { groupPlayerId: "a", score: 20_000, totalRebuyCount: 1 },
      { groupPlayerId: "b", score: 10_000, totalRebuyCount: 1 },
    ]);
  ...
  it("完全同点はgroupPlayerId昇順で決定する", () => {
    const result = calculateRanking([
      { groupPlayerId: "b", score: 10_000, totalRebuyCount: 1 },
      { groupPlayerId: "a", score: 10_000, totalRebuyCount: 1 },
    ]);
